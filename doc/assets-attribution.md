The following is a list of assets used in the moneta source and their proper attribution.
...
* License: MIT
* Site: [https://monetatalk.org/index.php?topic=15276.0](https://monetatalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original moneta logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/moneta.icns, src/qt/res/src/moneta.svg,
	src/qt/res/src/moneta.ico, src/qt/res/src/moneta.png,
	src/qt/res/src/moneta_testnet.png, docs/moneta_logo_doxygen.png,
