...
The Moneta Core GUI can be easily translated into other languages. Here's how we
...
is used to update moneta_en.ts. This process has been automated, from src/qt,
simply run:
    make translate
