Moneta version 0.5.4 is now available for download at:
http://sourceforge.net/projects/moneta/files/Moneta/moneta-0.5.4/
...
http://gitorious.org/moneta/monetad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Moneta-Qt notifications under Growl 1.3.
Increase required age of Moneta-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMoneta properly when installing Moneta-Qt over it. (Windows)
