Download URL: https://sourceforge.net/projects/moneta/files/Moneta/moneta-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MONET fee schedule (users still pay 0.01 MONET per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #moneta00 - #moneta99
