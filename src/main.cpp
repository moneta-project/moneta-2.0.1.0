...
// 	CAmount nSubsidy = nStartSubsidy;
	    ...
	    nSubsidy >>= (nHeight / Params().SubsidyHalvingInterval());
		 if(nHeight = 2 ) {nSubsidy = 84000000 * COIN;} //Ease in to 0 diff.
		 if(nHeight < 5000 ) {nSubsidy = 10 * COIN;} //Ease in to 0 diff.
		 if(nHeight < 10000 ) {nSubsidy = 5 * COIN;} //Ease in to 0 diff.
...
//	CAmount nSubsidy = (nHeight == 2 ? 84000000 : 1) * COIN;
//	CAmount nSubsidy = (nHeight < 5000 ? 10 : 1) * COIN;
//	CAmount nSubsidy = (nHeight < 10000 ? 5 : 1) * COIN;
