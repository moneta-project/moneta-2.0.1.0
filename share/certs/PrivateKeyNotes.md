...
unlocked to sign the Moneta-Qt.app bundle.
...
allowing somebody to distribute a Moneta-Qt.app or moneta-qt-setup.exe with a valid
...
that the moneta-qt.exe file inside the installer had not been tampered with.
